...
### Parallelization 
## New riboav calculation 
# Parameter exploration - KHill, A and B 
...
$khill[0]=5;  # $khl
$khill[1][0]=20; $khill[1][1]=30; $khill[1][2]=40; $khill[1][3]=50; $khill[1][4]=60;  

$parA[0]=5;  ## $A 
$parA[1][0]=10; $parA[1][1]=20; $parA[1][2]=30; $parA[1][3]=40; $parA[1][4]=50;  

$parB[0]=5; ## $tlinrate 0.1 to 10
$parB[1][0]=1; $parB[1][1]=2; $parB[1][2]=5; $parB[1][3]=7; $parB[1][4]=10; ;      

$tlr[0]=8; ## $tlinrate 0.1 to 10
$tlr[1][0]=0.1; $tlr[1][1]=0.5; $tlr[1][2]=1; $tlr[1][3]=2; $tlr[1][4]=4; $tlr[1][5]=6; $tlr[1][6]=8;  $tlr[1][7]=10;

$aat[0]=5; ## $tlinrate 0.1 to 10
$aat[1][0]=50; $aat[1][1]=75; $aat[1][2]=100; $aat[1][3]=125; $aat[1][4]=150;   
...
while($runfl==0) 
{
   ...
   if($tcl==1) 
   {
     for($jj=0;$jj<$parA[0];$jj++)
     {
        $A=$parA[1][$jj]; 
        for($cc=0;$cc<$tlr[0];$cc++)
        {
          $tlinrate=$tlr[1][$cc]; 
  	  $khl=$A+$A*5/(5+$tlinrate);
          $trvtime=($orflen-1)/$aatrav+log($orflen)*$khl/$aatrav; ## Hill fn.  
          $t10=(10-1)/$aatrav+log(10)*$khl/$aatrav; 
...
for($mc=0;$mc<$mp;$mc++) ##
{
   ...
   open(WR,">../results/parameter_expl_waittime4/$modrun"."_NoiseData.txt") or die; 
  ...
  open(WR,">../results/parameter_expl_waittime4/$modrun"."_Burst_SizeFreq.txt") or die; 
  print WR "$modrun mRNArate $mrnarate mRNAhl $mrnahl Onrate $onrate Offrate $offrate TLon $tlon TLoff $tloff TlInrate $tlinrate Ktr $khl TrvTi $trvtime Trv10 $t10 ProtHL $prothl\n";
